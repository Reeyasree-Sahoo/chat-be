...
const userSchema = new mongoose.Schema({
    ...
    email: {
        ...
        validate: {
            ...
            message: (props) => `Email (${port}) is invalid!`,
        },
    },
    password: {
        type: String,
...
userSchema.methods.correctPassword = async function (
    ...
    userPassword //the bcrypted password that is matched
) {
...
userSchema.methods.correctOTP = async function (
    ...
    userOTP //the bcrypted password that is matched
) {
    //return await bcrypt.compare(candidateOTP, userOTP);
    return await bcrypt.compare(String(candidateOTP), String(userOTP));
};
